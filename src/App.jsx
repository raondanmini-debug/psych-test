...
const DIMS = [
{
id: “d1”, name: “방어기제”, icon: “🛡️”, color: “#CE93D8”,
qs: [
“불편한 감정이 생기면 ‘그럴 수도 있지’로 넘기거나 논리적으로 설명하며 덮어버리는 편이다”,
“내가 얼마나 상처받았는지 한참 지나서야 알아차리는 경우가 많다”,
“힘든 상황이 생기면 ‘없던 일로 하자’며 피하거나 외면하는 편이다”,
“속으로는 힘들어도 겉으로는 괜찮은 척, 밝은 척을 습관적으로 하는 편이다”,
],
},
{
id: “d2”, name: “애착유형”, icon: “💞”, color: “#F48FB1”,
qs: [
“안정적으로 잘 대해주는 사람보다 불규칙하게 나를 설레게 하는 사람에게 더 끌리는 경향이 있다”,
“상대가 날 떠날까봐 자주 불안하다. 또는 반대로 관계가 가까워질수록 도망치고 싶어진다”,
“나에게 진심으로 잘 대해주는 사람이 오히려 의심스럽거나 어색하게 느껴진다”,
“사람들이 너무 가까이 다가오면 불편해서 거리를 두고 싶어진다”,
],
},
{
id: “d3”, name: “인지왜곡”, icon: “🧩”, color: “#80DEEA”,
qs: [
“한 번 실패하거나 거절당하면 ‘나는 원래 이런 사람이야’로 확대 해석하는 경향이 있다”,
“칭찬을 받아도 자연스럽게 받아들이기 어렵고 의심되거나 불편하다”,
“내 생각·감정·외모·행동 등 작은 부분까지 과도하게 비판하는 편이다”,
“내 자존감은 주로 다른 사람이 나를 어떻게 생각하느냐에 달려 있다”,
],
},
{
id: “d4”, name: “회복탄력성”, icon: “⚡”, color: “#A5D6A7”,
qs: [
“힘든 일이 있을 때 ‘어떻게 하면 나아질까’보다 ‘왜 나한테 이런 일이’에 더 오래 머문다”,
“기분 상태가 바뀌면 하던 계획이나 루틴이 완전히 무너지는 경우가 많다”,
“새로운 것을 시도하기 전에 ‘잘 못하면 어떡하지’라는 두려움이 먼저 온다”,
“감정이 격해지면 차분하게 생각하는 것이 매우 어렵다”,
],
},
{
id: “d5”, name: “신체신호”, icon: “🫀”, color: “#FFAB91”,
qs: [
“특정 가족과 대화하거나 연락받은 후 몸이 긴장되거나 피로감, 두통 등이 나타난다”,
“누군가 나에게 불만이 있을 것 같으면 마음속에서 쉽게 털어내지 못한다”,
“비판이나 지적을 받으면 감정적으로 강하게 반응하는 편이다”,
“상처받거나 배신당한 감정을 오래 품고 있는 편이다”,
],
},
{
id: “d6”, name: “과도한통제”, icon: “🎯”, color: “#FFD54F”,
qs: [
“내가 충분히 노력하면 대부분의 문제를 해결할 수 있다고 믿어서 혼자 다 짊어지는 편이다”,
“내가 나서지 않으면 일이 잘못될 것 같아 남에게 맡기거나 의지하는 것이 어렵다”,
“모든 것이 내 통제 범위 안에 있을 때만 비로소 마음이 놓인다”,
“타인의 문제를 해결해주고 싶은 충동을 자주 느끼고 실제로 나서는 편이다”,
],
},
{
id: “d7”, name: “자책죄책감”, icon: “🔗”, color: “#EF9A9A”,
qs: [
“가족 중 누군가가 화내거나 기분이 나쁠 때, 그것이 어쩐지 내 탓인 것 같다는 생각이 든다”,
“가족 안에서 생긴 문제를 내가 해결해야 한다는 부담을 느꼈거나 느낀다”,
“가족을 위해 더 해야 했는데 못 했다는 죄책감이 자주 올라온다”,
“가족의 기대에 부응하지 못할 때 지나치게 자책하는 편이다”,
],
},
];
...
id: dim.id, name: dim.name, icon: dim.icon, color: dim.color,
...
function getScoreCopy(total, ti) {
if (total <= 70) return {
hook: “점수는 낮아도, 이 테스트를 시작한 이유가 있었을 거예요.”,
body: “아무 이유 없이 ‘심리 독립 테스트’를 클릭한 건 아니었겠죠.\n마음 한켠에 여전히 뭔가 걸리는 게 있다면, 그게 바로 지금 봐야 할 것일 수 있어요.\n\n심층 분석은 낮은 점수 안에 숨어있는 작은 균열을 짚어드려요.\n균열은 지금 작을 때 보는 게 맞아요.”,
cta: “지금 내 균열 확인하기 →”,
};
if (total <= 105) return {
hook: “지금 당신은 회복의 경계선에 있어요.”,
body: “이 점수대가 사실 가장 위험해요.\n’나쁘지 않네’라고 넘어가기엔 패턴이 조용히 관계와 돈에 영향을 주고,\n’심각하다’고 느끼기엔 일상이 굴러가거든요.\n\n지금 이 패턴을 정확히 보지 않으면 3년 후에도 같은 자리예요.”,
cta: “지금 내 패턴 끊기 →”,
};
return {
hook: “이 점수는 혼자 감당하기엔 꽤 무거운 패턴들이에요.”,
body: “나쁜 게 아니에요. 오래 버텨온 거예요.\n\n근데 이 패턴들, 방치하면\n관계에서, 돈에서, 건강에서 계속 같은 방식으로 반복돼요.\n\n지금 딱 한 번만 제대로 들여다보면\n그 반복의 고리를 끊을 수 있어요. 21일이면 돼요.”,
cta: “지금 고리 끊기 →”,
};
}
...
“화가 나도 참고, 나중에 혼자 삭히는 경우가 더 많다”,
“내가 뭘 잘못한 것도 아닌데, 왜인지 자꾸 미안해진다”,
“충분히 잘하고 있는데도 늘 부족한 것 같은 기분이 든다”,
“가까워질수록 불안하거나, 아예 거리를 두고 싶어진다”,
“나를 위한 선택을 하면 죄책감이 올라온다”,
];
...
function animate(fn) {
setIsAnim(true);
setTimeout(() => { fn(); setIsAnim(false); setSelOpt(null); }, 280);
}

function goBack() {
if (screen === SCREENS.PART0) {
if (p0Idx > 0) { setP0Idx(p0Idx - 1); setSelOpt(null); }
else setScreen(SCREENS.INTRO);
} else if (screen === SCREENS.PART1) {
if (qIdx > 0) { setQIdx(qIdx - 1); setSelOpt(null); }
else if (dimIdx > 0) { setDimIdx(dimIdx - 1); setQIdx(DIMS[dimIdx - 1].qs.length - 1); setSelOpt(null); }
else { setScreen(SCREENS.PART0); setP0Idx(PART0_Qs.length - 1); }
...
setSelOpt(val);
setTimeout(() => {
setP0Answers(prev => ({ …prev, [`p0_${p0Idx}`]: val }));
animate(() => {
...
else if (dimIdx < DIMS.length - 1) { setDimIdx(dimIdx + 1); setQIdx(0); }
...
setEmailError(“올바른 이메일 주소를 입력해주세요 (예: name@email.com)”);
return;
}
setEmailError(””);
...
1. 닉네임으로 시작
1. 가장 높은 패턴 1~2가지를 구체적으로 언급 (차원 이름 쓰지 말고 행동/감정으로 표현)
1. 그 패턴이 어디서 왔는지 따뜻하게 한 문장으로
1. 오늘 바로 할 수 있는 아주 구체적인 행동 한 가지
1. 응원 문장으로 마무리
  ...
  <div style={S.wrap}>
    ...
    {screen === SCREENS.INTRO && (
      <div>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{ fontSize: "11px", letterSpacing: "4px", color: "#CE93D8", textTransform: "uppercase", marginBottom: "16px" }}>라온단미 · 심리 독립 테스트</div>
          <h1 style={{ fontSize: "clamp(24px,5vw,32px)", fontWeight: 900, lineHeight: 1.2, marginBottom: "12px" }}>
            나는 왜 이럴까,<br />한 번쯤 생각해본 적 있나요?
          </h1>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "28px" }}>
          {CHECKLIST.map((item, i) => (
            <div
              ...
              style={{ display: "flex", alignItems: "flex-start", gap: "12px", background: checkedItems.includes(i) ? "rgba(206,147,216,0.12)" : "rgba(255,255,255,0.03)", border: `1.5px solid ${checkedItems.includes(i) ? "rgba(206,147,216,0.5)" : "rgba(255,255,255,0.08)"}`, borderRadius: "12px", padding: "14px 16px", cursor: "pointer", transition: "all 0.2s" }}
            >
              <div style={{ width: "20px", height: "20px", borderRadius: "6px", border: `2px solid ${checkedItems.includes(i) ? "#CE93D8" : "rgba(255,255,255,0.25)"}`, background: checkedItems.includes(i) ? "#CE93D8" : "transparent", flexShrink: 0, marginTop: "1px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px" }}>
        ...
        <div style={{ background: "rgba(206,147,216,0.08)", border: "1px solid rgba(206,147,216,0.2)", borderRadius: "16px", padding: "20px 22px", marginBottom: "24px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "15px", lineHeight: 1.85, color: "rgba(255,255,255,0.85)", marginTop: "8px" }}>
            그건 의지가 약해서도, 성격이 이상해서도 아니에요.<br />
            <strong style={{ color: "#CE93D8" }}>오래된 패턴이 지금도 작동하고 있는 거예요.</strong>
          </p>
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.55)", marginTop: "12px", lineHeight: 1.7 }}>
            어디서 시작됐는지, 지금 나에게 어떻게 남아있는지<br />8분이면 파악할 수 있어요.
          </p>
        </div>

        <button style={S.primaryBtn} onClick={() => setScreen(SCREENS.PART0)}>
          지금 바로 확인하기 →
        </button>

        <div style={{ marginTop: "20px", padding: "14px 16px", background: "rgba(255,200,0,0.05)", border: "1px solid rgba(255,200,0,0.15)", borderRadius: "10px", fontSize: "11.5px", color: "rgba(255,255,255,0.4)", lineHeight: 1.7 }}>
          ⚠️ 이 테스트는 심리 패턴 파악을 위한 자기계발 도구입니다. 의료적 진단 및 전문 심리상담을 대체하지 않습니다.
        </div>
      </div>
    )}
    ...
    {screen === SCREENS.PART0 && (
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ height: "4px", background: "rgba(255,255,255,0.1)", borderRadius: "2px" }}>
              <div style={S.progressBar(((p0Idx + 1) / PART0_Qs.length) * 100)} />
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "9px" }}>
          {P0_OPTS.map(opt => (
            <button key={opt.value} style={S.btn(selOpt === opt.value)} onClick={() => handleP0Select(opt.value)}>
              <span style={S.circle(selOpt === opt.value)}>{selOpt === opt.value ? "✓" : ""}</span>
              {opt.label}
            </button>
          ))}
        </div>
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ height: "4px", background: "rgba(255,255,255,0.1)", borderRadius: "2px" }}>
              <div style={S.progressBar(progress, DIMS[dimIdx].color)} />
            </div>
          </div>
        </div>
        <div style={S.card(isAnim)}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "9px" }}>
          {OPTS.map(opt => (
            <button key={opt.value} style={S.btn(selOpt === opt.value, DIMS[dimIdx].color)} onClick={() => handleMainSelect(opt.value)}>
              <span style={S.circle(selOpt === opt.value, DIMS[dimIdx].color)}>{selOpt === opt.value ? "✓" : ""}</span>
              {opt.label}
            </button>
          ))}
        </div>
        <div style={{ marginTop: "18px", display: "flex", gap: "6px" }}>
          {DIMS.map((d, i) => (
            <div key={d.id} style={{ flex: 1, height: "4px", borderRadius: "2px", background: i < dimIdx ? d.color : i === dimIdx ? `${d.color}66` : "rgba(255,255,255,0.1)", transition: "all 0.3s" }} />
          ))}
        </div>
      </div>
    )}
    ...
    {screen === SCREENS.EMAIL && (
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.55)", marginBottom: "24px", lineHeight: 1.7, fontSize: "14px" }}>
          이메일을 입력하면 무료 결과를 바로 확인할 수 있어요
        </p>
        <div style={{ textAlign: "left", display: "flex", flexDirection: "column", gap: "14px", marginBottom: "18px" }}>
          ...
          <div>
            ...
            <input value={email} onChange={e => { setEmail(e.target.value); setEmailError(""); }} placeholder="example@email.com" type="email"
              style={{ ...S.input, borderColor: emailError ? "#EF5350" : "rgba(206,147,216,0.3)" }} />
          ...
          <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(206,147,216,0.15)", borderRadius: "12px", padding: "16px" }}>
            <label style={{ display: "flex", gap: "10px", alignItems: "flex-start", cursor: "pointer", marginBottom: "12px" }}>
              ...
              <span style={{ fontSize: "12px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6 }}>
                ...
                이메일을 수집하여 테스트 결과 발송 목적으로만 사용합니다.
              </span>
            </label>
            <label style={{ display: "flex", gap: "10px", alignItems: "flex-start", cursor: "pointer" }}>
              ...
              <span style={{ fontSize: "12px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6 }}>
                <strong style={{ color: "rgba(255,255,255,0.8)" }}>[선택] 마케팅 정보 수신 동의</strong><br />
                신규 콘텐츠, 할인 정보를 이메일로 받겠습니다. 언제든지 수신 거부 가능.
              </span>
            </label>
          </div>
        </div>
    ...
    {screen === SCREENS.FREE_RESULT && scores && (() => {
      ...
      const scoreCopy = getScoreCopy(scores.total, ti);
      ...
      return (
        <div>
          ...
          {/* AI 편지 미리보기 블러 */}
          {aiLetter && (
            <div style={{ background: "linear-gradient(145deg,#0D0020,#2A0A40)", border: "1px solid rgba(206,147,216,0.25)", borderRadius: "14px", padding: "20px", marginBottom: "24px", position: "relative", overflow: "hidden" }}>
              <div style={{ fontSize: "11px", color: "#CE93D8", letterSpacing: "2px", marginBottom: "12px" }}>라온단미의 맞춤 편지</div>
              <div style={{ fontSize: "14px", lineHeight: 1.9, color: "rgba(255,255,255,0.85)", maxHeight: "80px", overflow: "hidden", position: "relative", filter: "blur(0px)" }}>
                {aiLetter.slice(0, 60)}...
              </div>
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "80px", background: "linear-gradient(transparent,#0D0020)" }} />
          ...
          {!timer.expired && (
            <div style={{ background: "linear-gradient(135deg,rgba(239,83,80,0.2),rgba(183,28,28,0.2))", border: "1.5px solid rgba(239,83,80,0.5)", borderRadius: "14px", padding: "16px 18px", marginBottom: "16px", textAlign: "center" }}>
              ...
              <div style={{ fontSize: "28px", fontWeight: 900, color: "#fff", marginBottom: "4px", fontVariantNumeric: "tabular-nums" }}>{timer.display}</div>
              <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.65)" }}>이 시간 안에 구매 시 <strong style={{ color: "#FFA726" }}>₩99,000 → ₩69,000</strong></div>
            </div>
          )}
          ...
          <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(206,147,216,0.2)", borderRadius: "14px", padding: "20px", marginBottom: "20px" }}>
            <div style={{ fontSize: "16px", fontWeight: 800, marginBottom: "10px", color: "#CE93D8" }}>{scoreCopy.hook}</div>
            <div style={{ fontSize: "13.5px", color: "rgba(255,255,255,0.72)", lineHeight: 1.85, whiteSpace: "pre-line", marginBottom: "16px" }}>{scoreCopy.body}</div>
          </div>
          ...
          <div style={{ background: "linear-gradient(135deg,rgba(106,27,154,0.3),rgba(156,39,176,0.2))", border: "1.5px solid rgba(206,147,216,0.4)", borderRadius: "18px", padding: "24px", marginBottom: "14px" }}>
            ...
            <div style={{ fontSize: "13.5px", color: "rgba(255,255,255,0.65)", lineHeight: 1.8, marginBottom: "18px" }}>
              ✅ 7가지 패턴 상세 해설 (원인 + 변화 방향)<br />
              ✅ 라온단미 맞춤 편지 전문<br />
              ✅ 나를 구하는 21일 전자책<br />
              ✅ 1:1 맞춤 분석 레터 (48시간 내 발송)
            </div>
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px" }}>
              <button onClick={() => setScreen(SCREENS.PAID_RESULT)} style={{ flex: 1, background: "transparent", border: "1.5px solid rgba(206,147,216,0.5)", borderRadius: "12px", padding: "14px 10px", color: "rgba(255,255,255,0.7)", cursor: "pointer", fontSize: "13px", lineHeight: 1.5 }}>
                📊 상세 리포트만<br /><strong style={{ color: "#fff", fontSize: "15px" }}>₩9,900</strong>
              </button>
              <button onClick={() => setScreen(SCREENS.PAID_RESULT)} style={{ flex: 1, background: "linear-gradient(135deg,#6A1B9A,#9C27B0)", border: "none", borderRadius: "12px", padding: "14px 10px", color: "#fff", cursor: "pointer", fontSize: "13px", lineHeight: 1.5 }}>
                📖 전자책 풀패키지<br />
                {!timer.expired
                  ? <><s style={{ opacity: 0.6, fontSize: "12px" }}>₩99,000</s> <strong style={{ fontSize: "15px", color: "#FFD54F" }}>₩69,000</strong></>
                  : <strong style={{ fontSize: "15px" }}>₩99,000</strong>
                }
              </button>
            </div>
            ...
            <div style={{ background: "rgba(0,0,0,0.2)", borderRadius: "10px", padding: "14px", textAlign: "center", marginBottom: "12px" }}>
              <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.75)", lineHeight: 1.7 }}>
                지금 이 페이지를 닫으면<br />
                오늘 본 내 패턴 분석 결과는 사라져요.<br />
                <strong style={{ color: "#CE93D8" }}>오늘 본 것, 오늘 확인하세요.</strong>
              </div>
            </div>

            <div style={{ fontSize: "10.5px", color: "rgba(255,255,255,0.3)", textAlign: "center", lineHeight: 1.6 }}>
              디지털 콘텐츠 특성상 구매 후 콘텐츠 열람 시 환불이 어려울 수 있습니다.<br />
              구매 전 무료 결과를 충분히 확인해주세요.
            </div>
          </div>

          <button style={S.ghostBtn} onClick={() => {
            setScreen(SCREENS.INTRO); setAnswers({}); setP0Answers({});
            setP0Idx(0); setDimIdx(0); setQIdx(0);
            setEmail(""); setNick(""); setAiLetter("");
            setScores(null); setResultStartTime(null); setCheckedItems([]);
          }}>처음부터 다시하기</button>
        </div>
      );
    })()}
      ...
      return (
        <div>
          ...
          <div style={{ background: "linear-gradient(135deg,rgba(106,27,154,0.4),rgba(156,39,176,0.3))", border: "1.5px solid #9C27B0", borderRadius: "14px", padding: "20px", marginBottom: "24px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: "13.5px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
              결제 후 아래 상세 분석 전체가 공개됩니다.<br />결제 확인 즉시 이메일로도 발송해드려요.
            </div>
            <div style={{ display: "flex", gap: "10px" }}>
              <button style={{ flex: 1, background: "rgba(255,255,255,0.08)", border: "1.5px solid rgba(255,255,255,0.2)", borderRadius: "12px", padding: "14px", color: "#fff", cursor: "pointer", fontSize: "14px" }}>
                📊 리포트만<br /><strong>₩9,900</strong>
              </button>
              <button style={{ flex: 1.3, background: "linear-gradient(135deg,#6A1B9A,#9C27B0)", border: "none", borderRadius: "12px", padding: "14px", color: "#fff", cursor: "pointer", fontSize: "14px" }}>
                📖 전자책 풀패키지<br />
                {resultStartTime && (Date.now() - resultStartTime < 3600000)
                  ? <><s style={{ opacity: 0.6, fontSize: "11px" }}>₩99,000</s> <strong style={{ color: "#FFD54F" }}>₩69,000</strong></>
                  : <strong>₩99,000</strong>
                }
              </button>
            </div>
            <div style={{ marginTop: "12px", fontSize: "12px", color: "rgba(255,255,255,0.45)" }}>
              카카오페이 · 네이버페이 · 카드 결제 가능<br />
              결제 후 즉시 이메일 발송
            </div>
          </div>
          ...
          <div style={{ position: "relative", overflow: "hidden" }}>
            <div style={{ filter: "blur(5px)", pointerEvents: "none", userSelect: "none" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginBottom: "20px" }}>
                {[...scores.dimScores].sort((a, b) => b.score - a.score).map(d => {
                  const lev = getLev(d.score);
                  const details = {
                    방어기제: { cause: "어릴 때 감정을 표현했을 때 무시되거나 처벌을 받은 경험에서 비롯됩니다.", tip: "오늘 불편했던 감정을 종이에 한 문장으로만 적어보세요. 판단 없이." },
                    애착유형: { cause: "예측 불가능했던 부모의 반응이 신경계를 항상 경계 모드로 만들었습니다.", tip: "나에게 잘 대해주는 사람에게 짧게 감사 메시지 하나 보내보세요." },
                    인지왜곡: { cause: "반복적인 비판과 기대 미달 경험이 자기 자신에 대한 왜곡된 렌즈를 만들었습니다.", tip: "오늘 내가 잘 한 것 딱 3가지를 손으로 적어보세요." },
                    회복탄력성: { cause: "실패 시 충분한 지지를 받지 못한 환경이 무력감을 학습하게 했습니다.", tip: "딱 10분만 전자책 D1 미션을 해보세요." },
                    신체신호: { cause: "만성적 스트레스가 신체에 축적되어 감정이 몸으로 먼저 신호를 보내고 있습니다.", tip: "4-7-8 호흡 3회. 숨 4초 들이쉬기 → 7초 참기 → 8초 내쉬기." },
                    과도한통제: { cause: "아무것도 믿을 수 없었던 환경에서 내가 다 해야 살아남는다를 학습했습니다.", tip: "오늘 한 가지만 다른 사람에게 맡기고 결과를 보세요." },
                    자책죄책감: { cause: "부모의 감정 조절 실패를 자신의 탓으로 돌리게 된 구조에서 비롯됩니다.", tip: "이것은 내 탓이 아니다를 오늘 한 번 소리 내서 말해보세요." },
                  };
                  const det = details[d.name] || { cause: "원가족 환경의 영향으로 형성된 패턴입니다.", tip: "전자책을 통해 구체적인 실천법을 확인하세요." };
                  return (
                    <div key={d.id} style={{ background: "rgba(255,255,255,0.04)", border: `1.5px solid ${lev.color}33`, borderRadius: "14px", padding: "18px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
                        <span style={{ fontSize: "15px", fontWeight: 700 }}>{d.icon} {d.name}</span>
                        <span style={{ background: lev.color, color: "#fff", borderRadius: "12px", padding: "2px 10px", fontSize: "12px", fontWeight: 700 }}>{lev.label}</span>
                      </div>
                      <div style={{ height: "6px", background: "rgba(255,255,255,0.08)", borderRadius: "3px", marginBottom: "14px" }}>
                        <div style={{ height: "100%", width: `${(d.score / d.max) * 100}%`, background: lev.color, borderRadius: "3px" }} />
                      </div>
                      <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", lineHeight: 1.7, marginBottom: "10px" }}>
                        <span style={{ color: "#CE93D8", fontWeight: 600 }}>원인: </span>{det.cause}
                      </div>
                      <div style={{ background: "rgba(206,147,216,0.1)", borderRadius: "8px", padding: "10px 13px", fontSize: "13px", color: "rgba(255,255,255,0.8)" }}>
                        <span style={{ color: "#CE93D8", fontWeight: 600 }}>오늘 딱 하나: </span>{det.tip}
                      </div>
                    </div>
                  );
                })}
            ...
            {/* 블러 오버레이 */}
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, transparent 0%, rgba(13,0,32,0.95) 60%)", display: "flex", alignItems: "flex-end", justifyContent: "center", paddingBottom: "20px" }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: "14px", color: "rgba(255,255,255,0.7)", marginBottom: "12px" }}>결제 후 전체 내용이 공개됩니다</div>
              </div>
            </div>
          </div>
